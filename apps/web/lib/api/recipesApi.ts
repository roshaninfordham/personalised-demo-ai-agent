...
export function createDemoRecipe(productId: string, request: CreateDemoRecipeRequest): Promise<DemoRecipe> {
  return apiRequest<DemoRecipe>(productRecipesEndpoint(productId), { method: "POST", body: request });
}
