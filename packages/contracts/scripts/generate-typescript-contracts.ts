...
const FILE_NAME_MAP = new Map<string, string>([
  ...
  ["crm-export.schema.json", "crmExport.ts"],
  ["crm-payload.schema.json", "crmPayload.ts"],
  ["feature-shown.schema.json", "featureShown.ts"],
  ["lead-insight.schema.json", "leadInsight.ts"],
  ["lead-summary.schema.json", "leadSummary.ts"],
  ["post-demo-job.schema.json", "postDemoJob.ts"],
