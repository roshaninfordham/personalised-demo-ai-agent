...
FILE_NAME_MAP = {
    ...
    "crm-export.schema.json": "crm_export.py",
    "crm-payload.schema.json": "crm_payload.py",
    "feature-shown.schema.json": "feature_shown.py",
    "lead-insight.schema.json": "lead_insight.py",
    "lead-summary.schema.json": "lead_summary.py",
    "post-demo-job.schema.json": "post_demo_job.py",
